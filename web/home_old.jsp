    ...
    <body>
        ...
        <div class="container-fluid">
                ...
                <div class="container-fluid" style=" background:#337ab7;">
                    ...
                    <div class="collapse navbar-collapse" id="hamburger-navigation">
                        ...
                        <ul class="nav navbar-nav" role="menu">
                            <li><a href="#" class="active">BMI Data</a><span class="sr-only">current</span></li>
            ...
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li class="active"><a href="#tabs-enter" role="tab" data-toggle="tab"><div class="glyphicon glyphicon-pencil"></div>Enter BMI</a></li>
                <li><a href="#tabs-edit" role="tab" data-toggle="tab"><div class="glyphicon glyphicon-edit"></div>Edit BMI</a></li>
            </ul>
            <!-- Tab Content -->
            <div class="tab-content">
                <div class="active tab-pane fade in col-lg-offset-2 col-lg-8 col-sm-12 col-xs-12" id="tabs-enter" style="padding-top: 30pt;">
                    <!--Enter data here-->
                    <!--<div id="traineeDataDiv">-->
                        <table  id="traineeTable" class="table borderbox table-bordered">
                            <thead class="bg-primary">
                                <tr>
                                    <th>S No.</th>
                                    <th>Ignite ID</th>
                                    <th>Name</th>
                                    <th title="Centimeters" >Height (in cm)</th>
                                    <th title="Kilograms">Weight (in kg)</th>
                                    <th title="Body Mass Index">B.M.I.</th>
                                    <th>Submit</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="tab-pane fade col-lg-offset-2 col-lg-8 col-sm-12 col-xs-12" id="tabs-edit" style="padding-top: 30pt;">
                    <!--Edit data here-->
                    <!--<div id="traineeEditDataDiv">-->
                        <table  id="traineeEditDataTable" class="table borderbox table-bordered">
                            <thead class="bg-primary">
                                <tr>
                                    <th>S No.</th>
                                    <th>Ignite ID</th>
